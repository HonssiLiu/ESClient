...
public class DocServiceThread {

	private static final Logger logger = LogManager.getLogger(DocServiceThread.class);
	...
	public DocServiceThread(Client client, String index) {
